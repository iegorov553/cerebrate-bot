...
class TestCommandRefactoring:
    ...
    def mock_update(self):
        ...
        update.effective_user = User(id=123456789, is_bot=False, first_name="TestUser", username="testuser")
    ...
    def test_module_imports_without_errors(self):
        ...
        from bot.handlers.commands.config_commands import freq_command, window_command
